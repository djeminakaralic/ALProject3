report 50111 "Electronic Sales VAT Book"
{
    DefaultLayout = RDLC;
    //ĐK RDLCLayout = './KIF.rdlc';
        ...
        dataitem(DataItem1; "VAT Entry")
        {
            ...
            dataitem(DataItem2; "Detailed VAT Entry")
            {
                ...
                begin
                    ...
                    Total71 := Total71 + Column711;
                    Total81 := Total81 + Column811;
                    ...
                    OutStreamObj.WRITETEXT(FORMAT(Replace(Column711)) + ';');
                    OutStreamObj.WRITETEXT(FORMAT(Replace(Column811)) + ';');
            ...
            begin
                ...
                OutStreamObj.WRITETEXT(FORMAT(Replace(Total71)) + ';');
                OutStreamObj.WRITETEXT(FORMAT(Replace(Total81)) + ';');
