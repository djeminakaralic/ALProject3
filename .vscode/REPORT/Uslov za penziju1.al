report 50223 "Uslov za penziju1"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Uslov za penziju1.rdlc';
    ...
    dataset
    {
        dataitem(DataItem17; Employee)
        {
            ...
            column(EducationLevelPU_Employee; "Education Level PU")
            {
            }
            column(LevelofGraduation_Employee; "Level of Graduation")
            {
            }
            ...
            column(NazivUOJ_Employee; "Naziv UOJ")
            {
            }
            column(OrgjedPU_Employee; "Org. jed PU")
            {
            }
            column(Year1_Employee; Year1)
            {
            }
            column(NazivOrgjedPU_Employee; "Naziv Org. jed PU")
            {
            }
            ...
            begin
                brojac := brojac + 1;
                EmployeeRec.CALCFIELDS("Department code", "Sector Code", "Naziv UOJ", "Position Code", "Department Name", "Šiffra pozicije po sistem.", "Naziv pozicije po sistem");
